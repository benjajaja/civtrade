...
echo '<div class="panelControl panel-info"><!--Currently in public beta, requires a verified account. -->
	...
	<a href="http://'.$url.'/api/cities.php?token='.$userInfo['confcode'].'">http://'.$url.'/api/cities.php</a> returns a list of cities and the total number of offers available<br><br>
