...
//Set sendTo
if(isset($_GET['to'])) { $sendTo = strip_tags($_GET['to']); }
else { $sendTo = ''; }

//Set msg
if (isset($_GET['msg'])) { $msg = strip_tags($_GET['msg']); }
else { $msg = ''; }
...
echo '<div class="panelControl panel-primary">
	...
	<form method="POST" class="form-inline;" action="../actions/sendpm.php"> <div class="form-group"> 
        ...
        <div class="input-group">
          ...
          <textarea class="form-control" rows="5" name="message" placeholder="All HTML tags are automatically removed">'.$msg.'</textarea>
        </div><br>
